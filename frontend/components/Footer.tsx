          ...
          >
            <div className="flex items-center space-x-2 mb-6">
              <div className="w-8 h-8 bg-black dark:bg-white rounded-lg flex items-center justify-center">
                <span className="font-bold text-white dark:text-black">H</span>
              </div>
              <span className="font-sans font-semibold text-lg text-black dark:text-white">HomeHunt</span>
            </div>
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="flex items-start space-x-3">
                ...
                <span className="text-gray-700 dark:text-gray-300">hello@homehunt.in</span>
              </div>
              <div className="flex items-start space-x-3">
